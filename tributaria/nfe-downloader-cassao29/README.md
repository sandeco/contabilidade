...
- [x] **Processamento**: consulta SOAP ao endpoint `NFeDistribuicaoDFe` da SEFAZ, paginando por NSU (Número Sequencial Único), descompactando GZIP e validando assinatura.
...
- `lxml` (parsing de XML assinado)
- `cryptography` (validação de cadeia e assinatura)
